...
SPOOL /orahome/u01/app/oracle/local/logs/show_expired__&&dbname&&hostname&&timestamp&&suffix
...
where
	...
	and (u.account_status like 'EXPIRE%' or u.account_status = 'LOCKED(TIMED)') 
order by
        CREATED,
        username,
        profile

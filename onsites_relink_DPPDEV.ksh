...
# the OEM job name is: RELINK_ONSITES_DPPDEV
# ... jrs
#
###############################################################################
...
SCRPTCNT=`ps -ef | grep -i "onsites_relink_DPPDEV.ksh" |grep -v grep |wc -l`
print "SCRPTCNT:" ${SCRPTCNT}  | teeout
if [ ${SCRPTCNT} -gt 2 ]; then
 echo 'RELINK_ONSITES_DPPDEV Overlap' | sendmail -r bermane@aetna.com -v 8603928025@vtext.com
echo 'RELINK_ONSITES_DPPDEV Overlap' | sendmail -r bermane@aetna.com -v bermane@aetna.com
echo 'RELINK_ONSITES_DPPDEV Overlap' | sendmail -r SchloendornT@aetna.com -v 2152625546@vtext.com
echo 'RELINK_ONSITES_DPPDEV Overlap' | sendmail -r SchloendornT@aetna.com -v SchloendornT@aetna.com
 exit 1
fi
...
if [ $? -eq 0 ]; then
  ...
  echo 'One or more dbs are still running on DPPDEV...' | sendmail -r bermane@aetna.com -v 8603928025@vtext.com
  echo 'One or more dbs are still running on DPPDEV...' | sendmail -r bermane@aetna.com -v bermane@aetna.com
echo 'One or more dbs are still running on DPPDEV...' | sendmail -r SchloendornT@aetna.com -v 2152625546@vtext.com
echo 'One or more dbs are still running on DPPDEV...' | sendmail -r SchloendornT@aetna.com -v SchloendornT@aetna.com 
exit 1
...
if [ $? -eq 0 ]; then
  ...
  echo "|*|exiting this script..."                            | teeout
  echo                                                        | teeout
  echo 'One or more listeners are still running on DPPDEV...' | sendmail -r bermane@aetna.com -v 8603928025@vtext.com
  echo 'One or more listeners are still running on DPPDEV' | sendmail -r bermane@aetna.com -v bermane@aetna.com
echo 'One or more listeners are still running on DPPDEV...' | sendmail -r SchloendornT@aetna.com -v 2152625546@vtext.com
echo 'One or more listeners are still running on DPPDEV' | sendmail -r SchloendornT@aetna.com -v SchloendornT@aetna.com 
 exit 1
fi
...
do
  ...
  if [ ${ERRCNT} -gt 0 ] ; then
       ...
       echo
       echo 'Errors Encountered relinking on DPPDEV' | sendmail -r bermane@aetna.com -v 8603928025@vtext.com
       echo 'Errors Encountered relinking on DPPDEV' | sendmail -r bermane@aetna.com -v bermane@aetna.com
       echo 'Errors Encountered relinking on DPPDEV' | sendmail -r SchloendornT@aetna.com -v 2152625546@vtext.com
       echo 'Errors Encountered relinking on DPPDEV' | sendmail -r SchloendornT@aetna.com -v SchloendornT@aetna.com
       exit 1
    else
       echo
       echo " |*| No Errors Encountered relinking on DPPDEV" >> ${_out}
       echo 'Relink completed on DPPDEV. No Errors Encountered' | sendmail -r bermane@aetna.com -v 8603928025@vtext.com
       echo 'Relink completed on DPPDEV. No Errors Encountered' | sendmail -r bermane@aetna.com -v bermane@aetna.com
       echo 'Relink completed on DPPDEV. No Errors Encountered' | sendmail -r SchloendornT@aetna.com -v 2152625546@vtext.com
       echo 'Relink completed on DPPDEV. No Errors Encountered' | sendmail -r SchloendornT@aetna.com -v SchloendornT@aetna.com
       echo
    fi
    #if [ $? -eq 0 ]; then
    #echo " |*| there may be errors in the above relink log..."      >> ${_out}
...
MAILIDSONSITES=`paste -s /u01/app/oracle/aetna/mail/onsites_mail_list`

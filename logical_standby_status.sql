...
select * from (select event_time, status_code, cast(status as varchar2(100)) as status, cast(event as varchar2(200)) as event_part , cast(XIDUSN ||','|| XIDSLT||','||XIDSQN as varchar2(25)) as XID

...
DECLARE
   ...
   IS
   select table_name from dba_segments ,PROD.WORKTABLE where segment_name = table_name and  tablespace_name IN ('DATA') and segment_type = 'TABLE' ORDER BY TABLE_SIZE DESC;

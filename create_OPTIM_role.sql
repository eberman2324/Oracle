...
spool create_OPTIM_role_${ORACLE_SID}.out
...
GRANT DELETE ON "PROD"."MEMBERSHIP" TO "OPTIM";
GRANT INSERT ON "PROD"."MEMBERSHIP" TO "OPTIM";
GRANT SELECT ON "PROD"."MEMBERSHIP" TO "OPTIM";
GRANT UPDATE ON "PROD"."MEMBERSHIP" TO "OPTIM";

...
# ----------------------------------------------------------
#  
# To get change information use PVCS comments.                        
#
###########################################################################
# -----------------------------------------------------------
USAGE="Usage: hotbackuptape.ksh arg1 arg2 arg3 (arg1=ORACLE_SID, arg2=Batchsize, arg3=Retention Days)"
#------------------------------------------------------------
...
RUNTHIS=$INSTANCE_OUTPUTS/backups/HOTBKP$DATETIME/hbackup_all.ksh
...
run_process()
{
   ...
   then
      ...
      hotbackupbatchtape $BATCHSIZE $RETPER
